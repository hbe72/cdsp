...
namespace test_convert_nearest_rounding_elastic_number
{
    ...
    static constexpr auto b = cnl::convert<cnl::nearest_rounding_tag, cnl::native_rounding_tag,
        cnl::elastic_scaled_integer<4, -1>,cnl::elastic_scaled_integer<8, -4>>(a);
...
static constexpr auto c = cnl::convert<cnl::nearest_rounding_tag, cnl::native_rounding_tag,
        cnl::elastic_scaled_integer<4, -2>,cnl::elastic_scaled_integer<8, -4>>(a);
...
//    static constexpr auto b = cnl::convert<cnl::nearest_rounding_tag, cnl::native_rounding_tag,
//        cnl::fixed_point<int, -4>,cnl::fixed_point<int, -1>>(a);
//
